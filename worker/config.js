...
// Import protocol metadata from dedicated protocols module
import { getProtocolInfo } from './protocols.js'

// Re-export protocol functions for convenience
export { getProtocolInfo }
...
export const CONFIG = {
  ...
  DEFAULT_SLIPPAGE: '.01', // 1% in case nothing is provided in frontend
